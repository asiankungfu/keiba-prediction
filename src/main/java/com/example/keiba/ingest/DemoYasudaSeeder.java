...
public class DemoYasudaSeeder implements CommandLineRunner {
    ...
    private static final String ENTRIES_CSV = """
            1,レーベンスティール,牡,戸崎圭,58,17,7,12,45
            2,ロングラン,セ,ゴンサルベス,58,25,5,12,28
            3,オフトレイル,牡,菅原明,58,18,3,12,55
            4,シックスペンス,牡,武豊,58,12,5,12,55
            5,サクラトゥジュール,セ,佐々木,58,28,6,12,50
            6,ステレンボッシュ,牝,レーン,56,14,3,12,68
            7,スズハローム,牡,藤懸,58,20,5,12,42
            8,シャンパンカラー,牡,岩田康,58,18,3,12,60
            9,ウォーターリヒト,牡,高杉,58,14,3,12,63
            10,ルクソールカフェ,牡,岩田望,58,12,6,12,32
            11,ワールズエンド,牡,津村,58,10,6,12,68
            12,シリウスコルト,牡,横山和,58,21,4,12,38
            13,セイウンハーデス,牡,幸,58,18,5,12,48
            14,ガイアフォース,牡,横山武,58,21,5,12,75
            15,ドラゴンブースト,牡,丹内,58,12,3,12,45
            16,パンジャタワー,牡,松山,58,9,4,12,65
            17,トロヴァトーレ,牡,ルメール,58,16,9,12,70
            """;
