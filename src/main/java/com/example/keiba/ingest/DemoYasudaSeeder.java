...
public class DemoYasudaSeeder implements CommandLineRunner {
     ...
     *
     * <p>条件適性は主観ではなく「<b>芝1400〜1800m（＝安田記念1600mと同条件帯）の3着内率</b>」を
     * 100倍したデータ駆動値。同じような条件で馬券圏内に来た割合で算出している。</p>
     */
    private static final String ENTRIES_CSV = """
            1,レーベンスティール,牡,戸崎圭,58,17,7,12,75
            2,ロングラン,セ,ゴンサルベス,58,25,5,12,25
            3,オフトレイル,牡,菅原明,58,18,3,12,45
            4,シックスペンス,牡,武豊,58,12,5,12,60
            5,サクラトゥジュール,セ,佐々木,58,28,6,12,45
            6,ステレンボッシュ,牝,レーン,56,14,3,12,60
            7,スズハローム,牡,藤懸,58,20,5,12,50
            8,シャンパンカラー,牡,岩田康,58,18,3,12,45
            9,ウォーターリヒト,牡,高杉,58,14,3,12,60
            10,ルクソールカフェ,牡,岩田望,58,12,6,12,20
            11,ワールズエンド,牡,津村,58,10,6,12,65
            12,シリウスコルト,牡,横山和,58,21,4,12,30
            13,セイウンハーデス,牡,幸,58,18,5,12,35
            14,ガイアフォース,牡,横山武,58,21,5,12,75
            15,ドラゴンブースト,牡,丹内,58,12,3,12,40
            16,パンジャタワー,牡,松山,58,9,4,12,55
            17,トロヴァトーレ,牡,ルメール,58,16,9,12,75
            """;
